...
def kominfo_tahunan():
    ...
    kominfo_tahunan = kominfo.groupby(["bulan", "tahun"])["judul"].count().reset_index().rename(columns={"judul": "total"})
    ordered_months = ["January", "February", "March", "April", "May", "June",
                      "July", "August", "September", "October", "November", "December"]
    kominfo_tahunan['to_sort']=kominfo_tahunan['bulan'].apply(lambda x:ordered_months.index(x))
